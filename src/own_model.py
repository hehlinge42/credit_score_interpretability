...
class OwnClassifierModel:
    ...
    def _preprocess_data(self) -> None:
        ...
        pipeline_preprocessing = make_column_transformer(
            (OrdinalEncoder(), self.categorical_features) #TODO: check whether we want one-hot encoder instead (risk of fucking with SHAP and other methods)
        ...
        self.X_test_preprocessed = pipeline_preprocessing.transform(self.X_test.drop(columns=[self.prediction_column, "y_hat"]))